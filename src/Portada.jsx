  ...
  return (
    <>
      ...
      <div className="text-center m-2">
        ...
        <h4>CEREMONIA</h4>
        <p>
          La ceremonia se realizará el 14 de Enero a las 19:00 horas en la
          Parroquia San Roque, San Miguel de Tucumán. Tocá el botón de abajo
          para recibir las indicaciones para llegar.
        </p>
      ...
      <div className="text-center m-4">
        ...
        <h4>FIESTA</h4>
        <p>
          Después de la ceremonia festejaremos en Kaké Eventos, Tafí Viejo de
          20:00 a 4:00 AM. Tocá el botón de abajo y encontrá las indicaciones
          para llegar, te esperamos!
        </p>
      ...
      <div className="text-center img-text img-height">
        ...
        <br />
        <p className="pb-3">
          La fiesta esta preparada para que los adultos la pasen genial y los
          mas chicos se queden en casa
        </p>
